import unittest
from calculator import User, Product, Order, Promotion, Promotion_usage_limit, Promo_Requirement_Checker, Order_sum_Promo_Requirement_Checker, Item_Amount_Promo_Requirement_Checker, Order_sum_usage_limit_Promo_Requirement_Checker, Promo_Deduction_Calculator, Percentage_Promo_Deduction_Calculator, Sum_Promo_Deduction_Calculator, FreeItem_Promo_Deduction_Calculator, DiscountPromo_Calculator,  Nopromo_Calculator, FixedDiscountPromo_Calculator, FreeItem_Promo_Calculator
...
# 適用場景：特定商品滿 X 件折 Y 元、滿 X 元折 Y 元，在全站總共只能套⽤ N 次
